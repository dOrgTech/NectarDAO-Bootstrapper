...
<StepBox>
    ...
    <Subtitle>Convert ETH into wETH. You can do this from the UI in Balancer</Subtitle>
    <Subtitle>Stake NEC & wETH into the Balancer Pool in a 50/50 Ratio to receive BPT</Subtitle>
    <Subtitle>(balancer pool link)</Subtitle>
</StepBox>
<StepBox>
    <Title>Hold the BPT in your Private Wallet</Title>
    <Subtitle>Your BPT Balance</Subtitle>
    <Subtitle>Simply hold the BPT tokens in your private wallet. You do not need to do anything else with them</Subtitle>
    <Subtitle>BPT tokens are evidence that you have provided liquidity to the NEC/wEth Balancer Pool</Subtitle>
</StepBox>
<StepBox>
    <Title>Wait for Weekly Snapshot 1</Title>
    <Subtitle>Once per week a snapshot of BPT token holders will be taken and necDAO Reputation distributed</Subtitle>
    <Subtitle>Reputation is the voting power in the necDAO. You can use it to submit and vote on NEC & DeversiFi proposals</Subtitle>
</StepBox>
<StepBox>
    <Title>Have your say in the NEC DAO</Title>
    <Subtitle>You can submit proposals and vote on proposals governing the Nectar and DeversiFi in the necDAO from the moment that you have received your Reputation</Subtitle>
    <Subtitle>(go to necDAO)</Subtitle>
    <Subtitle>Participation in the necDAO does not impact NEC Beehive rewards, but we hope you will participate</Subtitle>
</StepBox>
<StepBox>
